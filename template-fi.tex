...
\frac{1}{avaimia(I)}
\end{equation}
jos sarakkeessa on indeksi kyseiselle relaatiolle. \cite{selinger1979access} Ilman indeksiä kyselyn optimoija käyttää kiinteää arvoa vähennyskertoimen arvioimiseen, joka esimerkiksi System R-relaatiotietokantaohjelmassa on 1/10.
...
-tyyppiselle ehdolle vähennyskerroin voidaan arvioida kaavalla
\begin{equation}
\frac{1}{MAX (avaimia(I1), avaimia(I2))}
\end{equation}
jos kummassakin sarakkeessa on indeksi. Lisäksi oletetaan, että jokaisesta pienemmän indeksin arvoa vastaa arvo toisesta indeksistä. Mikäli vain toisessa sarakkeessa on indeksi, 
