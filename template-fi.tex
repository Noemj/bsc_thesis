...
Relaatiotietokanta on relaatiomalliin perustuva tietokanta. Relaatiomallissa tietokanta nähdään joukkona alkioiden(mikä alkio?) muodostamia matemaattisia relaatioita, ja se tarjoaa deklaratiivisen menetelmän datan ja kyselyjen määrittämiseen. Relaatiomallin matemaattisessa määritelmässä attribuutti on pari joka sisältää attribuutin nimen ja tyypin sekä siihen liittyvän arvojoukon. Monikko on järjestetty joukko attribuuttien arvoja. Relaatio koostuu otsakkeesta ja kehosta (body?), jossa otsake on joukko attribuutteja ja keho on joukko monikkoja. Relaation otsake on myös jokaisen monikon otsake. Visuaalisessa esityksissä relaatio on taulukko ja monikko taulukon rivi. 
