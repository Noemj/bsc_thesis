...
Selinger et al esittelivät artikkelissaan \cite{selinger1979access} System R-tietokantaohjelmiston OPTIMIZER-komponentin, joka on ensimmäisiä relaatiomalliin pohjautuvia kyselyn optimoijia. System R:n esittelemä dynaaminen ohjelmointi on käytössä eri muodoissa käytännössä kaikissa kaupallisissa järjestelmissä. \cite{ioannidis1996query}
...
Optimoija voi suorittaa usean peräkkäisen join-operaation liittämisen monella eri tavalla. Tutkitaan kyselyä $A \Join B \Join C \Join D$. Left-deep puuksi kutsutaan tapaa liittää kyselyt seuraavasti: $(((A \Join B) \Join C) \Join D)$, jossa oikea lapsi on aina kantataulu. Optimoijat käyttävät usein pelkästään left-deep puita, sillä eri tapoja liittää join-operaatioita on join-operaatioiden määrän kasvaessa liikaa. Toinen syy on left-deep puiden mahdollistama putkitus. \cite{ramakrishnan2003database}
