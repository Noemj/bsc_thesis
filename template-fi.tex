...
\abstract{Tietokantakyselyn optimointi on prosessi, jossa tietokannan hallintajärjestelmä määrittää suorituskykyisimmän tavan kyselyn suorittamiseen. Kyselyn optimointi on NP-täydellinen ongelma, jossa mahdollisten suoritustapojen joukko voi kasvaa erittäin suureksi. Sillä on hallintajärjestelmän toimenpiteistä suurin vaikutus sen suorituskykyyn. Keskeisiä optimoinnin osa-alueita ovat mahdollisten suoritustapojen läpikäynti sekä niiden kustannusarviointi. Tutkielmassa tutustumme optimoinnin osa-alueisiin relaatiotietokantojen hallintajärjestelmien osalta sekä optimoinnin vaikutukseen kyselyjen suorituskyvyssä. Esittelemme vaihtoehtoisia tapoja mahdollisten suoritustapojen joukon luomiseen, kuten dynaamisen algoritmin joka hyödyntää heuristiikkoja epäoptimaalisten suoritustapojen karsimiseen. Tutkimme lisäksi tilastotiedon käyttöä suoritustapojen kustannusarvioinnissa parhaan suoritustavan valitsemiseksi. \\\newline ACM Computing Classification System (CCS): \newline \textbf{Information systems $\rightarrow$ Query optimization} \newline \textbf{Theory of computation $\rightarrow$ Database query processing and optimization (theory)}}
...
Kyselysuunnitelmien tuottamisessa kaikkien suunnitelmien läpikäyminen on usein liian hidasta, joten huomioitavien kyselysuunnitelmien joukkoa pyritään rajaamaan. Tutkimme yleisiä hakualgoritmeja kyselysuunnitelmien joukon tuottamiseen, joista dynaamiset algoritmit käyttävät heuristiikkoja kyselysuunnitelmien joukon rajaamiseen. Heuristiikkojen käyttäminen ei ole triviaalia, sillä toisinaan paras kyselysuunnitelma karsitaan heuristiikan takia. Sivusimme muita algoritmeja, kuten geneettistä algoritmia, vain pintapuolisesti.

Kyselysuunnitelmien kustannusarviossa keskeinen ongelma on tilastotiedon optimaalinen tallentaminen. Liian tarkka tilastotiedon tallentaminen rasittaa tietokannan käyttöä, mutta auttaa kyselysuunnitelmien optimoinnissa. 

%Optimaalisen tilastotiedon määritteleminen on edelleen tutkittava ongelma.

Jätimme tutkimatta suurimman osan tilastotiedon käytön teoriasta, sivuten vain aihetta yksinkertaisin esimerkein. Myös alikyselyn suorittamiseen tutkittiin vain kahta tapausta, sivuten monimutkaisemmat alikyselyt.

Kyselyn optimoinnin tutkimus on yhä laajamittaista. Viimeaikaiset tutkimukset käsittelevät grafiikkaprosessorin sekä rinnakkaisohjelmoinnin hyödyntämistä, mutta myös vaihtoehtoisia algoritmeja dynaamiselle algoritmille. Muita tutkittavia alueita ovat koneoppimisen käyttö suorituskykyisten kyselysuunnitelmien tunnistamiseen sekä tarpeettoman tilastotiedon karsiminen.
