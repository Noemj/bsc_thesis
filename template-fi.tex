...
Kyselyn optimoinnin tutkimus on yhä laajamittaista. Viimeaikaiset tutkimukset käsittelevät grafiikkaprosessorin sekä rinnakkaisohjelmoinnin hyödyntämistä \cite{heimel2012first, Wu:2011:QOM:2038916.2038928}, mutta myös vaihtoehtoisia algoritmeja dynaamiselle algoritmille \cite{sevincc2011evolutionary}. Muita tutkittavia alueita ovat koneoppimisen käyttö suorituskykyisten kyselysuunnitelmien tunnistamiseen \cite{borkar2012declarative} sekä optimaalinen tilastotiedot käyttö \cite{haas2009discovering}.
